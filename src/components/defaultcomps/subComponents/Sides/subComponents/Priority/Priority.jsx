...
function Priority({ burgerMenuClicked }){
    ...
    return (
        <div className='tasks-page-priority-div' style={{display: (isMicroScreen && !burgerMenuClicked && !expandBar) && 'none'}}>
            ...
            <PriorityComponents Dot={RedDot} PriorityLevel='High' TasksAtPriorityLevel= {highPriorityCount} burgerMenuClicked={ burgerMenuClicked}  />
            <PriorityComponents Dot={OrangeDot} PriorityLevel='Medium' TasksAtPriorityLevel={ mediumPriorityCount} burgerMenuClicked={ burgerMenuClicked}  />
            <PriorityComponents Dot={GreenDot} PriorityLevel='Low' TasksAtPriorityLevel={lowPriorityCount} burgerMenuClicked={ burgerMenuClicked}  />
