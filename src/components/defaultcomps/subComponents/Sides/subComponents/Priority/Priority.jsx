...
function Priority({ burgerMenuClicked }) {
    ...
    return (
        <div className='tasks-page-priority-div' style={{ display: (isMicroScreen && !burgerMenuClicked && !expandBar) && 'none' }}>
            ...
            <PriorityComponents url={"/tasks/high"} Dot={RedDot} PriorityLevel='High' TasksAtPriorityLevel={highPriorityCount} burgerMenuClicked={burgerMenuClicked} />
            <PriorityComponents url={"/tasks/medium"} Dot={OrangeDot} PriorityLevel='Medium' TasksAtPriorityLevel={mediumPriorityCount} burgerMenuClicked={burgerMenuClicked} />
            <PriorityComponents url={"/tasks/low"} Dot={GreenDot} PriorityLevel='Low' TasksAtPriorityLevel={lowPriorityCount} burgerMenuClicked={burgerMenuClicked} />
