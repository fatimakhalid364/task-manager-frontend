...
function Routes({ clickfunction, burgerMenuClicked }) {
    return (
        <div className='tasks-page-routes-div' >
            ...
            <RoutesComponents icon={GearIcon} currentPage='SETTINGS' page='Settings' route='/settings/general' clickfunction={clickfunction} burgerMenuClicked={burgerMenuClicked} />
            <Outlet />
